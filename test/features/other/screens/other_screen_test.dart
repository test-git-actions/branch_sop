...
void main() {
  ...
  testGoldens(
    ...
    (tester) async {
      ...
      await screenMatchesGolden(tester, 'other_widget_error_state');
    },
  );

  testGoldens(
    'OtherWidget - Loaded state with one link',
    (tester) async {
      const tLink = Link(
        id: 'id',
      ...
      await screenMatchesGolden(
        tester,
        'other_widget_loaded_state_one_link',
      );
    },
  );

  testGoldens(
    'OtherWidget - Loaded state with many links',
    (tester) async {
      const tLink = Link(
        id: 'id',
        name: 'Tournament of Kings',
      ...
      await screenMatchesGolden(
        tester,
        'other_widget_loaded_state_with_many_links',
      );
    },
  );
}
