...
void main() {
  ...
  testGoldens(
    ...
    (tester) async {
      ...
      await screenMatchesGolden(tester, 'rewards_widget_error_state');
    },
  );

  testGoldens(
    'RewardsWidget - Loaded state with one link',
    (tester) async {
      when(() => mockLinksCubit.state)
      ...
      await screenMatchesGolden(
        tester,
        'rewards_widget_loaded_state_one_link',
      );
    },
  );

  testGoldens(
    'RewardsWidget - Loaded state with many links',
    (tester) async {
      ...
      await screenMatchesGolden(
        tester,
        'rewards_widget_loaded_state_with_many_links',
      );
    },
  );
}
