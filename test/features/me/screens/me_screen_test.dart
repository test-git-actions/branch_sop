...
// import 'package:branch_links/core/links/models/link.dart';
// import 'package:branch_links/core/links/presentation/static_links_cubit/static_links_cubit.dart';
// import 'package:branch_links/core/presentation/theme.dart';
...
void main() {
  ...
  testGoldens(
    ...
    (tester) async {
      ...
      await screenMatchesGolden(tester, 'me_widget_error_state');
    },
  );

  testGoldens(
    'MeWidget - Loaded state with one link',
    (tester) async {
      const tLink = Link(
        id: 'id',
      ...
      await screenMatchesGolden(
        tester,
        'me_widget_loaded_state_one_link',
      );
    },
  );

  testGoldens(
    'MeWidget - Loaded state with many links',
    (tester) async {
      const tLink = Link(
        id: 'id',
        name: 'Tournament of Kings',
      ...
      await screenMatchesGolden(
        tester,
        'me_widget_loaded_state_with_many_links',
      );
    },
  );
}
