...
void main() {
  ...
  testGoldens(
    ...
    (tester) async {
      ...
      await screenMatchesGolden(tester, 'home_widget_error_state');
    },
  );

  testGoldens(
    'HomeWidget - Loaded state with one link',
    (tester) async {
      when(() => mockLinksCubit.state)
      ...
      await screenMatchesGolden(
        tester,
        'home_widget_loaded_state_one_link',
      );
    },
  );

  testGoldens(
    'HomeWidget - Loaded state with many links',
    (tester) async {
      ...
      await screenMatchesGolden(
        tester,
        'home_widget_loaded_state_with_many_links',
      );
    },
  );
}
