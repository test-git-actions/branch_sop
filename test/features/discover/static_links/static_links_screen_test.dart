...
void main() {
  ...
  testGoldens(
    'StaticLinksWidget - Loading state',
    (tester) async {
      ...
      await screenMatchesGolden(
        tester,
        'static_links_widget_loading_state',
  ...
  testGoldens(
    ...
    (tester) async {
      ...
      await screenMatchesGolden(tester, 'static_links_widget_error_state');
    },
  );

  testGoldens(
    'StaticLinksWidget - Loaded state with one link',
    (tester) async {
      const tLink = Link(
        id: 'id',
      ...
      await screenMatchesGolden(
        tester,
        'static_links_widget_loaded_state_one_link',
      );
    },
  );

  testGoldens(
    'StaticLinksWidget - Loaded state with many links',
    (tester) async {
      const tLink = Link(
        id: 'id',
        name: 'Tournament of Kings',
      ...
      await screenMatchesGolden(
        tester,
        'static_links_widget_loaded_state_with_many_links',
      );
    },
  );
}
